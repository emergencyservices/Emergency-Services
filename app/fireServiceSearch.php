...
$output = '';
	...
	$query = mysql_query("SELECT * FROM fireservicesdatabase WHERE keyword LIKE '%$searchq%'") or die ("could not Search!!");
...
<html>
    <head>
	  <title>Results: Fire Services</title>
	  <link href="fireServiceSearchStyle.css" rel="stylesheet" type="text/css">
	...
	<body>
			...
			<div><img src="Images/Page 01/Header/logo.png" class = "logo" ></div>
			  ...
			  <div class="searchTitle">Results for Fire Services</div>
			  
			  
			        <form action = "fireServiceSearch.php" method= "post" >
						<input type="text" name="fs" placeholder="enter your location.. e.g. gulshan"  value="<?php echo $_POST['fs']; ?>" id="searchBox" />
						<input type="submit" value="Search" id="searchButton" />
					</form>
					
					
					<div id ="seeAll"><a href="fireServiceSearchAll.php">Click Here to see full list of Fire Services<a/><div/>
