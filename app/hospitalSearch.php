...
$output = '';
	...
	$query = mysql_query("SELECT * FROM hospitaldatabase WHERE keyword LIKE '%$searchq%'") or die ("could not Search!!");
...
<html>
    <head>
	  <title>Results: Nearest Hospital</title>
	  <link href="hospitalSearchStyle.css" rel="stylesheet" type="text/css">
	...
	<body>
			...
			<div><img src="Images/Page 01/Header/logo.png" class = "logo" ></div>
			  ...
			  <div class="searchTitle">Results for Nearest Hospital</div>
			  
			  
			        <form action = "hospitalSearch.php" method= "post" >
						<input type="text" name="hs" placeholder="enter your location.. e.g. gulshan"  value="<?php echo $_POST['hs']; ?>" id="searchBox" />
						<input type="submit" value="Search" id="searchButton" />
					</form>
					
					<div id ="seeAll"><a href="hospitalSearchAll.php">Click Here to see full list of Hospitals<a/><div/>
