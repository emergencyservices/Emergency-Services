...
$output = '';
	...
	$query = mysql_query("SELECT * FROM bloodbankdatabase WHERE keyword LIKE '%$searchq%'") or die ("could not Search!!");
...
<html>
    <head>
	  <title>Results: Blood Bank</title>
	  <link href="bloodSearchStyle.css" rel="stylesheet" type="text/css">
	...
	<body>
			...
			<div><img src="Images/Page 01/Header/logo.png" class = "logo" ></div>
			  ...
			  <div class="searchTitle">Results for Blood Bank</div>
			  
			  
			        <form action = "bloodSearch.php" method= "post" >
						<input type="text" name="bs" placeholder="enter your location.. e.g. gulshan"  value="<?php echo $_POST['bs']; ?>" id="searchBox" />
						<input type="submit" value="Search" id="searchButton" />
					</form>
					
					
					<div id ="seeAll"><a href="bloodSearchAll.php">Click Here to see full list of Blood Bank<a/><div/>
