...
$output = '';
	...
	$query = mysql_query("SELECT * FROM ambulancedatabase WHERE keyword LIKE '%$searchq%'") or die ("could not Search!!");
			...
			<div><img src="Images/Page 01/Header/logo.png" class = "logo" ></div>
			  ...
			  <div class="searchTitle">Results for Emergency Ambulance</div>
			        ...
			        <form action = "ambulanceSearch.php" method= "post" >
						<input type="text" name="as" placeholder="enter your location.. e.g. gulshan"  value="<?php echo $_POST['as']; ?>" id="searchBox" />
